...
#define STRING_CONFIG_H_AUTHOR "(Tolsi, my config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Tolsi 3D"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 8, 100 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
// todo update info from the printer from desktop file
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 1000 } // 100 last?
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -10.8, -1.416 }
